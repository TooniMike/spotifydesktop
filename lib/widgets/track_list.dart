...
class TracksList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DataTable(
      headingTextStyle: Theme.of(context).textTheme.titleSmall!.copyWith(fontSize: 12.0),
      ...
      tracks.map((e) {
        ...
        final textStyle = TextStyle(color: selected ? Theme.of(context).indicatorColor : Theme.of(context).iconTheme.color);
        return DataRow(
          cells: [
